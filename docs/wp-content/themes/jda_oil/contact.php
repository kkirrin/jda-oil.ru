    ...
    <section class="section__map">
        <div class="container">
            ...
            <div class="md:pt-[40px] pt-[20px] contact__map flex md:flex-row flex-col gap-[40px]">
                <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A4996b586c219a113a4f8647c2e7f76dfcc84f0e18ec889c1d6e8310351515af8&amp;width=832&amp;height=432&amp;lang=ru_RU&amp;scroll=true"></script>
