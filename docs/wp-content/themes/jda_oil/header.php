    ...
    <div>
        <header class="z-10 w-full md-28 transition-colors"> 
            <div class="bg-green py-[12px] md:block sm:block hidden">
                <p class="text-white text-center"><?php echo get_field('promo_header'); ?></p>
            </div>
                ...
                <div class="relative w-full z-10 flex justify-between gap-5 items-center container">
                    <div class="md:block sm:hidden hidden">
                        <p class="text-dark-green" style="width: max-content !important;">
                            По всем вопросам писать на: <a href="mailto:<?php echo get_field('email_header'); ?>">
                    ...
                    <div style="width: -webkit-fill-available;" class="flex gap-[30px] items-center md:justify-right sm:justify-between justify-end">
                        ...
                        <div class="text-dark-green md:block sm:block hidden">
                            <a href="tel:+<?php echo get_field('phone_header-bot'); ?>" class="list-disc"><?php echo get_field('phone_header', 'option'); ?></a>
                        </div>
                    ...
                    <div class="container__special flex justify-between">                     
                        ...
                        <div class="mobile-menu w-full">
                            <ul class="text-dark-green text-base ">
                                ...
                                <li>
                                    <a href="mailto:<?php echo get_field('email_header'); ?>" class="text-dark-green text-[16px] pb-[15px]">:<?php echo get_field('email_header'); ?></a>
                                </li>
