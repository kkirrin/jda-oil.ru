...
<head>
    ...
    <title>JDA OIL - Японское масло от официального дилера.</title>
    ...
    <div>
        <header class="z-10 w-full md-28 transition-colors">
            ...
            <div class="md:gap-5 items-center flex-col md:pt-2">
                <div class="relative w-full z-10 flex justify-between gap-5 items-center container">
                    <div class="md:block sm:hidden hidden">
                        <p class="text-dark-green" style="width: max-content !important;">
                            По всем вопросам писать на: <a href="mailto:<?php echo get_field('email_header', 'option'); ?>">
                                <?php echo get_field('email_header', 'option'); ?>
                            </a>
                        </p>
                    </div>
                    ...
                    <a href="/" class="md:hidden sm:hidden block">
                        <img style="width: 50px;" class="object-fill" src="<?php echo get_template_directory_uri() . '/src/img/icons/jda-icon.png'; ?>" alt="">
                    </a>
                    ...
                    <div class="container__special flex justify-between">
                        <div class="flex gap-[20px] items-center md:w-auto w-[200px]" style="width: -webkit-fill-available;">
                            <a href="/" class="md:block sm:hidden hidden">
                                <img class="object-fill" style="width: 50px;" src="<?php echo get_template_directory_uri() . '/src/img/icons/jda-icon.png'; ?>" alt="">
                            </a>
                    ...
                    <?php include 'live-search.php'; ?>
                        ...
                        <div class="mobile-menu w-full">
                            <ul class="text-dark-green text-base ">
                                ...
                                <li>
                                    <a href="mailto:<?php echo get_field('email_header', "option"); ?>" class="text-dark-green text-[16px] pb-[15px]"><?php echo get_field('email_header', "option"); ?></a>
                                </li>
