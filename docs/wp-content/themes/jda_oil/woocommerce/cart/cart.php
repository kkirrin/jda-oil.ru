...
// Вывод атрибутов для каждого товара
					...
					if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
						...
						?>
							<div class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
								...
								<div class="product-subtotal" data-title="<?php esc_attr_e('Сумма', 'woocommerce'); ?>">
									<?php
...
<div class="new-card-item">
	...
	<div class="cart-collaterals cart-collaterals--card-page">
		<?php
		/**
	...
	<div class="wc-proceed-to-checkout wpc--darkluplite-element darkluplite--text-after darkluplite--text-before">
		
	<a href="popup5" class="checkout-button button alt wc-forward popup-link">
		Оформить заказ</a>
	</div>
